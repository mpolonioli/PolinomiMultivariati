...
;
; Esempi:
;    (as-polynomial '(+ 42 (* 42 (expt a 1))))) --> (POLY ((M 42 0 NIL) (M 42 ((V 1 A)))))
;
; -----------------------------------------------------------------------------------------
;
; Nome: VARPOWERS
...
;
; Semantica: 
;    Ritorna la lista dei simboli di variabile contenuti nella struttura <polynomial>,
;    oppure della struttura <monomial>, oppure nella struttura <polynomial> data dal
;    "parsing" di <espressione>
;
;    La lista dei simboli di variabile viene tornata in ordine lessicografico crescente
;    senza ripetizioni
;
; Esempi:
...
;
; Semantica:
;    Ritorna la lista dei simboli di variabile contenuti nella struttura <monomial>
;
;    La lista dei simboli di variabile viene tornata in ordine lessicografico crescente
;    senza ripetizioni
;
...
;
; Esempi:
;    (monomials '(POLY (M 1 2 ((V 1 A) (V 1 B))))) --> ((M 1 2 ((V 1 A) (V 1 B))))
;    (monomials '(M 1 2 ((V 1 A) (V 1 B)))) --> ((M 1 2 ((V 1 A) (V 1 B))))
;    (monomials '(+ (* a b)) --> ((M 1 2 ((V 1 A) (V 1 B))))
;
; -----------------------------------------------------------------------------------------
;
; Nome: COEFFICIENTS
...
;
; Semantica:
;    Ritorna la lista dei coefficienti di monomio contenuti nella struttura <polynomial>,
;    oppure la lista contenente il coefficiente contenuto nella struttura <monomial>,
;    oppure la lista dei coefficienti di monomio contenuti nella struttura <polynomial> 
;    data dal "parsing" di <espressione>
;
; Esempi:
...
;    <polynomial>, oppure il grado del monomio contenuto nella struttura <monomial>,
;    oppure il massimo grado di monomio dei monomi contenuti nella struttura <polynomial>
;    data dal "parsing" di <espressione>
;
; Esempi:
...
;    <polynomial>, oppure il grado del monomio contenuto nella struttura <monomial>,
;    oppure il minimo grado di monomio dei monomi contenuti nella struttura <polynomial>
;    data dal "parsing" di <espressione>
;
; Esempi:
...
;    stessa, ma che non sono pensate per essere utilizzate al di fuori
;
; -----------------------------------------------------------------------------------------
;
;                               EOF: END-OF-FILE                               
